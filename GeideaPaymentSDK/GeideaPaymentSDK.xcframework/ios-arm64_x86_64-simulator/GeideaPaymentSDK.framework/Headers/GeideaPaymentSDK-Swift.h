...
/// version:
/// 1.0`
+ (void)payWithTheAmount:(GDAmount * _Nonnull)amount withCardDetails:(GDCardDetails * _Nonnull)cardDetails config:(GDConfigResponse * _Nullable)config showReceipt:(BOOL)showReceipt andTokenizationDetails:(GDTokenizationDetails * _Nullable)tokenizationDetails andPaymentIntentId:(NSString * _Nullable)paymentIntentId andCustomerDetails:(GDCustomerDetails * _Nullable)customerDetails orderId:(NSString * _Nullable)orderId paymentMethods:(NSArray<NSString *> * _Nullable)paymentMethods dismissAction:(void (^ _Nullable)(GDCancelResponse * _Nullable, GDErrorResponse * _Nullable))dismissAction navController:(UIViewController * _Nonnull)navController completion:(void (^ _Nonnull)(GDOrderResponse * _Nullable, GDErrorResponse * _Nullable))completion;
